...
TOKEN = '7987425696:AAHnRX-yJrcJvS2lH_HcJ2O9TR4I57lNswg'
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = -1002283902162
CHANNEL_ID = -1002283902162
error_channel_id = -1002283902162
...
def myinfo_command(message):
    ...
    if not user_data:
        ...
        response = (f"*👤 USERNAME: @{Manjot Singh}* \n"  # Username
                    f"*💸 PLAN: {plan}* \n"  # User plan
